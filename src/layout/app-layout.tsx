...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'coach', path: '/coaches', entity: 'coach', service: AccessServiceEnum.PROJECT, icon: FiHome },
  {
    name: 'communication',
    path: '/communications',
  ...
  { name: 'event', path: '/events', entity: 'event', service: AccessServiceEnum.PROJECT, icon: FiHome },
  { name: 'player', path: '/players', entity: 'player', service: AccessServiceEnum.PROJECT, icon: FiHome },
